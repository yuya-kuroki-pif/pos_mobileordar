...
export const POS_MENU: MenuGroup[] = [
  ...
  },
  {
    ...
    label: 'アンケート分析',
    children: [
      { key: 'q-score', label: '店舗スコア一覧', href: '/questionnaireAnalytics/score', feature: 'questionnaire_analytics', pending: true },
      { key: 'q-comment', label: 'コメント一覧', href: '/questionnaireAnalytics/comment', feature: 'questionnaire_analytics', pending: true },
      { key: 'q-shop', label: '店舗詳細', href: '/questionnaireAnalytics/shop', feature: 'questionnaire_analytics', pending: true },
      ...
      { key: 'q-employee', label: 'スタッフ評価分析', href: '/employeeReviewAnalytics/ranking', feature: 'questionnaire_analytics', pending: true },
      ...
      { key: 'q-menu', label: 'メニュー評価分析', href: '/menuReviewAnalytics', feature: 'questionnaire_analytics', pending: true },
    ],
  },
  {
    key: 'export',
  ...
  },
  {
    ...
    label: '本部機能',
    children: [
      { key: 'daily-closing', label: '日次処理一覧', href: '/dailyCashRegisterBalancing', feature: 'daily_closing', pending: true },
      { key: 'accounting', label: '会計履歴一覧', href: '/accounting/history', feature: 'accounting_history', pending: true },
      { key: 'table-usage', label: 'テーブル利用履歴', href: '/tableUsageHistory', feature: 'table_usage_history', pending: true },
      { key: 'audit', label: '重要操作履歴一覧', href: '/auditLogs', feature: 'audit_logs', pending: true },
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'printing-main-option', label: 'プランオプション印刷設定', href: '/printing/mainOption', feature: 'shop_management', pending: true },
      ...
      { key: 'kitchen-order', label: 'キッチン表示・印刷順', href: '/menu/kitchen-display-order/edit', feature: 'shop_management', pending: true },
      { key: 'handy', label: 'ハンディ管理', href: '/handy', feature: 'shop_management', pending: true },
      { key: 'table', label: 'テーブル', href: '/table', feature: 'shop_management', pending: true },
      { key: 'preview', label: 'アプリ表示確認', href: '/previewUserApp', feature: 'shop_management', pending: true },
      { key: 'handout', label: '配布物', href: '/handout', feature: 'shop_management', pending: true },
    ],
  },
  {
    key: 'crm',
    label: 'CRM',
    children: [
      { key: 'message', label: 'メッセージ配信', href: '/messageDelivery', feature: 'crm', pending: true },
      { key: 'coupon', label: 'クーポン', href: '/coupon', feature: 'crm', pending: true },
      { key: 'minigame', label: 'ミニゲーム', href: '/miniGame', feature: 'crm', pending: true },
      { key: 'membership', label: '会員カード', href: '/membershipCard', feature: 'crm', pending: true },
      { key: 'mo-questionnaire', label: 'アンケート設定', href: '/questionnaire', feature: 'crm', pending: true },
    ],
  },
];
